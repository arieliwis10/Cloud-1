...
public class KafkaProducerConfig {
	...
	public static final String TOPIC = "Ubicaciones";
	...
	NewTopic topicHorarios() {
		return new NewTopic("Horarios", 3, (short) 2);
	}

	@Bean
	ProducerFactory<String, UbicacionDTO> producerFactory() {
	...
	@Bean
	KafkaTemplate<String, UbicacionDTO> kafkaTemplate() {
