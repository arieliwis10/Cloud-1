...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "grupo-horarios");
    ...
    @Bean
public ProducerFactory<String, HorarioDTO> producerFactory() {
...
@Bean
public KafkaTemplate<String, HorarioDTO> kafkaTemplate() {
